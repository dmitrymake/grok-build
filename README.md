...
Together binds the opt-in challengers to `openai/gpt-oss-120b` and serverless `openai/gpt-oss-20b`; the retained `Qwen/QwQ-32B` catalog entry is dedicated-endpoint-only because its serverless service was retired by the vendor.
